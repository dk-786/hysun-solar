...
// export default AddLicesingManager
...
const AddLicesingManager = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await fetch('https://solar-project-delta.vercel.app/api/auth/registerlicensemanager', {
                method: 'POST',
                headers: {
