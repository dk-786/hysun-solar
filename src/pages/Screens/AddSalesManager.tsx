...
const AddSalesManager = () => {
    const [formData, setFormData] = useState({
        ...
        villageorcity: '',
        pincode: '',
        attachdocs: [] as { name: string, url: string }[], // Attach docs in the required format
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await fetch('https://solar-project-delta.vercel.app/api/auth/registersalesmanager', {
                method: 'POST',
                headers: {
