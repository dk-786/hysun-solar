...
//             <label
//               htmlFor="cover"
//               className="flex cursor-pointer items-center justify-center gap-2 rounded bg-green-600 py-1 px-2 text-sm font-medium text-white hover:bg-opacity-90 xsm:px-4"
//             >
...
//               <label
//                 htmlFor="profile"
//                 className="absolute bottom-0 right-0 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full bg-green-600 text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2"
//               >
//                 <svg
//                   className="fill-current"
//                   width="14"
...
const Profile = () => {
  ...
  <div className="relative w-full h-full flex items-center justify-center">
    <img
      src={userData.data.profilephoto || userSix}
      alt="profile"
