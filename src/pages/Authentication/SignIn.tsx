...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('https://solar-project-delta.vercel.app/api/auth/login', {
        email,
        password,
      });
      console.log('Login successful:', response.data);
      // Handle successful login here (e.g., store tokens, redirect user)
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <div className="mt-6 text-center">
                <p>
                  ...
                  <Link to="/auth/signup" className="text-green-600">
                    Sign Up
                  </Link>
                </p>
              </div>
